...
- Use `/new` on the public wizard site to create a managed repo and deploy flow.
...
| Public `/new` | Creates a guided repo/deploy flow from an official template or blank project. |
