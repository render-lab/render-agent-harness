...
Render Harness gives agent projects a shared execution loop, durable state, runtime-specific entrypoints, tool wiring, scaffolding, and an operator UI.
...
- [Registry publishing](/registry-publishing/): Publish an entry with a generated Blueprint and pinned SHA.
- [Authoring capability packs](/authoring-capability-packs/): Ship reusable tools, MCP servers, and setup requirements.
- [Authoring bundle templates](/authoring-bundle-templates/): Add multi-agent starters to the template catalog.
